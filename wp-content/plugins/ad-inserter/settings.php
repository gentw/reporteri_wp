...
?>
      ...
      <div class="ai-form ai-rounded" style="height: 90px; padding: 8px 4px 8px 12px;">
        <a href="https://www.playwire.com/" class="clear-link" title="<?php _e ('Maximize Revenue', 'ad-inserter'); ?>" target="_blank"><img id="ai-pw-728" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>pw-728.png" /></a>
      </div>
<?php
      break;
...
<?php   break; case 4: ?>
            <a href="https://www.playwire.com/" class="clear-link" title="<?php _e ('Maximize Your Ad Revenue', 'ad-inserter'); ?>" target="_blank"><img id="ai-pw-25" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>pw-25.png" /></a>
<?php   break;
      } ?>
          </div>
