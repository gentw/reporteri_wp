...
*/
  ...
  jQuery(document).ready(function() {
    ...
    jQuery(window).scroll(function() {
      ...
      $('.reporteri_instant_post').each(function() {
        var top = $(this).offset().top - 200;
        var bottom = top + $(this).outerHeight();
        if (currentPos >= top && currentPos <= bottom) {
          var sectionId = $(this).attr('id');
          $('.reporteri_timeline_nav_link[href="#' + sectionId + '"]').addClass('reporteri_timeline_nav_link_active');
        } else {
          var sectionId = $(this).attr('id');
          $('.reporteri_timeline_nav_link[href="#' + sectionId + '"]').removeClass('reporteri_timeline_nav_link_active');
        }
      });
    });
  });
  ...
  jQuery('.reporteri_timeline_nav_link').click(function(event) {
    event.preventDefault(); 
