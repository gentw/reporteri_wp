...
<?php if(get_field( "live_article" ) == "YES" && $_GET['live']) { ?>
	...
	<div class="reporteri_timeline_news">
		<ul>
		<li><a class="reporteri_timeline_nav_link reporteri_timeline_nav_link_active" href="#mvp-post-head"><?php the_title(); ?></a></li>
		<?php
			$_post_nr = 0;
			$recent = new WP_Query(array( 'category_name' => "instant", 'posts_per_page' => -1, 'post__not_in' => array( $post->ID ), 'date_query' => array(
				array(
					'year' => date( 'Y' ),
					'month' => date( 'm' ),
					'day' => date( 'd' ),
				),
			) )); while($recent->have_posts()) : $recent->the_post(); ++$_post_nr;?>
			<li><a class="reporteri_timeline_nav_link" href="#instant_post_<?php echo $_post_nr ?>"><?php the_title(); ?></a></li>
		<?php
			endwhile;
			wp_reset_postdata();
		?>
	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php global $post; $mvp_post_layout = get_option('mvp_post_layout'); $mvp_post_temp = get_post_meta($post->ID, "mvp_post_template", true); if( ( empty($mvp_post_temp) && $mvp_post_layout == '4' ) || ( $mvp_post_temp == "def" && $mvp_post_layout == '4' ) || ( empty($mvp_post_temp) && $mvp_post_layout == '5' ) || ( $mvp_post_temp == "def" && $mvp_post_layout == '5' ) || ( $mvp_post_temp == "global" && $mvp_post_layout == '4' ) || ( $mvp_post_temp == "global" && $mvp_post_layout == '5' ) || $mvp_post_temp == "temp5" || $mvp_post_temp == "temp6" ) { ?>
			...
			<?php } ?>
		<?php } ?>
		<div id="mvp-article-cont" class="left relative reporteri_custom_article__mvp-article-cont">
			<div class="mvp-main-box reporteri_custom_article__mvp-main-box">
				<div id="mvp-post-main" class="left relative reporteri_custom_article__mvp-post-main">
					...
					<header id="mvp-post-head" class="left relative reporteri_instant_post">
						<h3 class="mvp-post-cat left relative"><a class="mvp-post-cat-link" ><span style="background: red!important;" class="mvp-post-cat left">LIVE</span></a></h3>
						<h1 class="mvp-post-title left entry-title reporteri-mvp-post-title" itemprop="headline"><?php the_title(); ?></h1>
						<?php if ( has_excerpt() ) { ?>
							<span class="mvp-post-excerpt left"><?php the_excerpt(); ?></span>
						<?php } ?>
...
<article id="mvp-article-wrap" itemscope itemtype="http://schema.org/NewsArticle" class="reporteri_single_article">
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<meta itemscope itemprop="mainEntityOfPage"  itemType="https://schema.org/WebPage" itemid="<?php the_permalink(); ?>"/>
		<?php global $post; $mvp_post_layout = get_option('mvp_post_layout'); $mvp_post_temp = get_post_meta($post->ID, "mvp_post_template", true); if( ( empty($mvp_post_temp) && $mvp_post_layout == '6' ) || ( $mvp_post_temp == "def" && $mvp_post_layout == '6' ) || ( empty($mvp_post_temp) && $mvp_post_layout == '7' ) || ( $mvp_post_temp == "def" && $mvp_post_layout == '7' ) || ( $mvp_post_temp == "global" && $mvp_post_layout == '6' ) || ( $mvp_post_temp == "global" && $mvp_post_layout == '7' ) || $mvp_post_temp == "temp7" || $mvp_post_temp == "temp8" ) { ?>
			<div id="mvp-vid-wide-wrap" class="left relative">
